...
RUN set -eux; \
    ...
    clone_if_missing https://github.com/cubiq/ComfyUI_essentials "${COMFYUI_DIR}/custom_nodes/ComfyUI_essentials"; \
    ...
    for req in \
      ...
      "${COMFYUI_DIR}/custom_nodes/comfyui_controlnet_aux/requirements.txt" \
      "${COMFYUI_DIR}/custom_nodes/comfyui_segment_anything/requirements.txt" \
      "${COMFYUI_DIR}/custom_nodes/atlascloud_comfyui/requirements.txt" \
      "${COMFYUI_DIR}/custom_nodes/ComfyUI_essentials/requirements.txt"; do \
